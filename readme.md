# This fork was produced so we could add a Python GUI for standalone lens control (no dependencies on ASCOM/INDI)
# for use with our bolt-on context camera on the Denali Bridge TX
